...
import getRequestSchema, { sortOrderEnum } from "../../../../types/getRequestSchema.js";
...
async function getEducationQualificationByEducationQualificationTypeId(request:Request,response:Response,next:NextFunction){
    ...
    const result = await getEducationQualificationByEducationQualificationTypeIdDBTransaction(
        id,
        query.start,
        query.rows,
        query.sortOrder
