...
async function createDisabilityTypeDB(
  prismaTransaction: any,
  data: postDisabilityTypeType
) {
...
async function createDisabilitySubTypeDB(
  prismaTransaction: any,
  data: postDisabilitySubTypeType
) {
  try {
    const disabilitySubType: DisabilitySubType =
      await prismaTransaction.disabilitySubType.create({
        data: data,
      });
