import {z} from "zod";
import {personalDetailsRequestSchema, updatePersonalDetailsRequestSchema,} from "./personalDetailsSchema.js";
...
import {DivyangDetailsColumnNamesEnum, DivyangDetailsSearchColumnNamesEnum,} from "./divyangDetailsDefaults.js";
...
const IdProofFileSchema = z.object({
    files: z.array(z.object({
        ...
        path: z.string(),
        size: z.number()
    })).min(2) // Ensure at least two files are uploaded
});
